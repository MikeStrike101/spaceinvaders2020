...
class Player(Ship):
    def __init__(self, x, y, health=100, enemies_killed=0):
...
def main():
    ...
    enemies_killed_font = pygame.font.SysFont("comicsans", 30)
    ...
    def redraw_window():
        ...
        enemies_label = main_font.render(f"You destroyed: {player.enemies_killed} spaceships", 1, (0, 255, 255))

        Window.blit(lives_label, (10, 10))
        Window.blit(level_label, (WIDTH - level_label.get_width() - 10, 10))
        Window.blit(enemies_label, (10, 80))
        ...
        if lost:
            lost_label = lost_font.render("You lost :( !!", 1, (0, 255, 255))
...
def main_menu():
    ...
    while run:
        Window.blit(BG, (0, 0))
        title_label = title_font.render("Let the fun begin!", 1, (0, 255, 255))
